...
var player;
console.log("queuePage.js loaded!");

// var element = document.createElement("script");
// element.src = "http://www.youtube.com/player_api";
// document.body.appendChild(element);
// console.log("Youtube API added");

function iFrameOfID(ID){
  var HTML = '<iframe width="640" height="390" frameborder="0" title="YouTube video player" type="text/html" src="http://www.youtube.com/embed/'
  HTML = HTML + ID;
  HTML = HTML + '?enablejsapi=1"></iframe>'
  return HTML;
}

function setVideo(){

  document.getElementById('player').innerHTML = iFrameOfID(queueObj.queue[0].videoID);
...
function onClientLoad() {
  console.log("client loaded!");
    gapi.client.load('youtube', 'v3', onYouTubePlayerAPIReady);
}
